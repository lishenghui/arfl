...
- ```./preprocess.sh -s niid --sf 0.1 -k 0 -t sample -tf 0.8``` (small-sized dataset)
- ```../preprocess.sh -s iid --sf 0.1 --iu 0.1 -k 0 -t sample -tf 0.8 --smplseed 0``` (small-sized iid dataset)
- ``` ./preprocess.sh -s niid --sf 0.1 -k 0 -t sample -tf 0.8 --smplseed 0``` (small-sized dataset)
